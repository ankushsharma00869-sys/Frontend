...
const SideMenu = ({ activeMenu }) => {
    ...
    return (
        <div className="w-64 h-[calc(100vh-61px)] bg-white border-r border-gray-200/20 p-5 sticky top-15.25 z-20 ">
            ...
            {SIDE_MENU_DATA.map((item, index) => (
                <button key={'menu_${index}'}
                    className={`w-full flex items-center gap-4 text-[15px] py-3 px-6 rounded-lg mb-3 transition-all duration-200 cursor-pointer ${activeMenu === item.label
