      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 space-y-12 lg:space-y-0 lg:grid lg:grid-cols-3 lg:gap-8">
           ...
           {pricingPlans.map((plan, index) => (
              ...
              <div key={index} className={'flex flex-col rounded-lg shadow-lg overflow-hidden ${pln.highlighted ? "border-2 border-purple-500 transform scale-105 ": "border border-gray-200"}'}>
                    ...
                    <ul className="space-y-4">
                      {plan.features.map((feature, featureIndex) => (
                        ...
                        <div className="rounded-md shadow">
                          ...
                          onClick={() => openSignUp()}
                          className={`w-full flex items-center px-5 py-3 text-base font-medium rounded-md transition-colors duration-200
                            ${plan.highlighted
